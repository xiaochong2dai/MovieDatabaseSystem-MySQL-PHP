...
-- ERROR 1452 (23000): Cannot add or update a child row: a foreign key constraint fails (`moviedatabase`.`moviedirector`, CONSTRAINT `moviedirector_ibfk_2` FOREIGN KEY (`did`) REFERENCES `Director` (`id`))
...
-- ERROR 1452 (23000): Cannot add or update a child row: a foreign key constraint fails (`moviedatabase`.`movieactor`, CONSTRAINT `movieactor_ibfk_2` FOREIGN KEY (`aid`) REFERENCES `Actor` (`id`))
